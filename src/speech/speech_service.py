...
class SpeechService:
    ...
    def __init__(self, tts_provider: str = "elevenlabs"):
        ...
        self.providers: Dict[str, ProviderTTS] = {
        ...
        if self.tts_provider not in self.providers:
            logger.warning(f"unknown tts provider '{tts_provider}', falling back to elevenlabs")
            self.tts_provider = "elevenlabs"
            
        logger.debug(f"speech service initialized with {self.tts_provider} provider")
        
        # initialize stt provider
        self.stt_provider = ElevenLabsSTT()
    ...
    def text_to_speech(
        ...
        **kwargs
        ...
        provider = self.providers[self.tts_provider]
